...
if (isset($_POST["submit"])){
    ...
    $db->run("UPDATE users2 SET name='$name', password='$password' WHERE id=$id");
...
if (isset($_GET["id"])) {
    ...
    $result = $->run("SELECT * FROM users2 WHERE id=$id");
...
<body class="P-3">
    <div class="d-flex justify-content-center">
        <form action="/chanderslv.github.io/w6l2/CRUD/add.php" method="post">
